...
class IncomeContagentNamesVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate  {
...
//    var companyList: NSArray = []
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "idtogototheincome", sender: self)
         
        }
    
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "idtogototheincome" {
