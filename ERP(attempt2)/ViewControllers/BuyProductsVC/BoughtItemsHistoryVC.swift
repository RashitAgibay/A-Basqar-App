//
//  BoughtItemsHistoryVC.swift
//  A-Basqar
//
//  Created by Ilyas Shomat on 1/20/20.
//  Copyright © 2020 Ilyas Shomat. All rights reserved.
//

import UIKit

class BoughtItemsHistoryVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "fromhiypimi", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "fromhiypimi" {
...
extension BoughtItemsHistoryVC {
