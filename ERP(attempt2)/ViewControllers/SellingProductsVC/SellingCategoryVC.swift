...
class SellingCategoryVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
      ...
      let eachCategory = dict["category"] as! NSDictionary
          ...
          performSegue(withIdentifier: "fromsellcategorytosellgood", sender: self)
      }
    ...
    //MARK: - Бір беттен екінші бетке қандай да юір ақпарат жіберу үшін.
      ...
      override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
          if segue.identifier == "fromsellcategorytosellgood" {
              if let destVC = segue.destination as? UINavigationController,
                  let targetController = destVC.topViewController as? SellingGoodsBasketVC {
                  targetController.categoryID = self.categoryID
              }
          }
      }
