...
class SellingBarcodeVC: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
   ...
   //                testForApi()
                   ...
                   getGoodByBarCode()
                   performSegue(withIdentifier: "fromvarcodetoselling", sender: self)
