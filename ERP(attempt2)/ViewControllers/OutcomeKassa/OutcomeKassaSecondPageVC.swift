//
//  OutcomeKassaSecondPageVC.swift
//  ERP(attempt2)
//
...
//        print("jdklisjdjjka;ldkja;ljds;ljdlskfhkjdsaghvbkpdhvpdhkvpd")
//        print(reversed_info_array)
...
//        print("here is a check id \(check_id)")
//        print("here is a history id \(history_id)")
        performSegue(withIdentifier: "outcomeKassas", sender: self)
     
    }

    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "outcomeKassas" {
            if let destVC = segue.destination as? UINavigationController,
                let targetController = destVC.topViewController as? OutcomeKassaHistoryItem {
...
extension OutcomeKassaSecondPageVC {
