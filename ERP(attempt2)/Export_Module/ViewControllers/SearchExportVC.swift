...
class SearchExportVC: DefaultVC {
...
extension SearchExportVC: UITableViewDelegate, UITableViewDataSource {
...
extension SearchExportVC: UISearchBarDelegate {
